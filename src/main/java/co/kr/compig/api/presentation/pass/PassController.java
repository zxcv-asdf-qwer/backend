...
public class PassController {
	...
	@Operation(summary = "admin url 만들기")
	@GetMapping("/admin")
	...
	@Operation(summary = "user용 url 만들기")
	@GetMapping("/user")
	public ResponseEntity<Response<?>> getUserPassTestPage(HttpServletRequest request, HttpServletResponse response,
		ModelMap modelMap) {
		CPClient niceCheck = new CPClient();
		...
		sReturnUrl = clientUrl + "/partner/profile-registration"; // 성공시 이동될 URL
		sErrorUrl = serverUrl + "/pass/fail"; // 실패시 이동될 URL
